...
-- Allows admins to invite users via email with pre-configured roles and permissions
...
CREATE TABLE IF NOT EXISTS public.user_invitations (
    ...
    -- Pre-configured permissions (JSONB for flexibility)
    tenant_ids UUID[] DEFAULT '{}',
    group_ids UUID[] DEFAULT '{}',
    managed_group_ids UUID[] DEFAULT '{}', -- For managers
...
-- Users can see their own invitations (by email, no auth required for acceptance page)
