                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          <span className={`inline-flex px-2 py-1 rounded-full text-xs font-medium ${
                            row.status === 'pendente' ? 'bg-gray-100 text-gray-800 dark:bg-gray-800 dark:text-gray-100' : 
                            row.status === 'rascunho' ? 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-100' : 
                            row.status === 'enviado' ? 'bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-100' : 
                            row.status === 'aprovado' ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-100' : 
                        ...
                        <td className="px-6 py-4 text-[var(--foreground)]">
                          {row.timesheet ? (
                            <div>
                              ...
                              <div className="text-sm text-[var(--muted-foreground)]">
                                {row.entries} {row.entries !== 1 ? 'entries' : 'entry'}
                              </div>
                            </div>
                          ) : (
                        ...
                        <td className="px-6 py-4 text-right">
                          {row.timesheet ? (
                            <Link 
                              href={`/${locale}/manager/timesheets/${row.timesheet.id}`}
